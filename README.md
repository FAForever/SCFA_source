...
# Forged Alliance Source Code

This repository includes source code for Supreme Commander: Forged Alliance. This release does not provide original GPGnet component. Check out alternative launcher like the FAForever project.
...
To use the compiled binaries, you must own the game. Forged Alliance is available for purchase on [gog.com](https://www.gog.com/en/game/supreme_commander_gold_edition) or [Steam](https://store.steampowered.com/app/9420/Supreme_Commander_Forged_Alliance/).

The quickest way to build all configurations in the project is to open `rts.dsw` in Microsoft Visual Studio C++ 6.0 (SP6 recommended for binary matching to Forged Alliance patch 3608) and select Build -> Batch Build, then hit the “Rebuild All” button.
